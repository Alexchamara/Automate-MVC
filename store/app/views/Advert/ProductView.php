...
<div class="my-[11%] mx-[7%]">
        ...
        <div class="ad-top-preview flex flex-col md:flex-row gap-4 items-start  bg-center bg-cover bg-no-repeat">
            ...
            <div class="bg-white pt-0 pb-4 px-4 md:pt-0 md:pb-4 md:px-4 w-full md:w-1/2 flex flex-col gap-5">
                ...
                <!-- Title Section -->
                <div class="pb-5">
                    <h1 class="text-xl md:text-4xl font-bold text-blue-900">Suzuki Swift Beatle <?= $car['make'] ?></h1>
...
<script type="text/javascript">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const thumbnailImages = thumbnails.querySelectorAll('img'); // Show buttons only if there are more than 6 images 
